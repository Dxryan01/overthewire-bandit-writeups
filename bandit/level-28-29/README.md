...
**Solution**:
1. Clone the repo on your own local machine then go to cloned repertory : `git clone ssh://bandit28-git@bandit.labs.overthewire.org:2220/home/bandit28-git/repo` → `cd repo`
